...
export default function NotFound() {
  ...
  const t = {
    "404.title":
      currentLocale === "id" ? "Halaman Tidak Ditemukan" : "Page Not Found",
    "404.description":
      currentLocale === "id"
        ? "Maaf, kami tidak dapat menemukan halaman yang Anda cari. Halaman mungkin telah dipindahkan, dihapus, atau tidak ada."
        : "Sorry, we couldn't find the page you're looking for. It might have been moved, deleted, or doesn't exist.",
    "404.goHome": currentLocale === "id" ? "Kembali ke Beranda" : "Go Home",
    "404.goBack": currentLocale === "id" ? "Kembali" : "Go Back",
    "404.help":
      currentLocale === "id"
    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      ...
      >
        ...
        >
          ...
          <p className="text-lg text-gray-600 mb-6">{t["404.description"]}</p>
        </motion.div>
