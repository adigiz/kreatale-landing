...
import { TourExperiencesBrowse } from "@/components/demo/tour/tour-browse-ui";
...
export default async function TourExperiencesPage({
  params,
}: {
    ...
    <TourDemoShell config={config}>
      <main className="pb-28 lg:pb-10">
        <TourSubpageHero
          ...
          slug={slug}
        />
        <TourExperiencesBrowse config={config} locale={locale} slug={slug} />
