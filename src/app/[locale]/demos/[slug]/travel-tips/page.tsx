...
import { TourTravelTipsBrowse } from "@/components/demo/tour/tour-browse-ui";
import {
  TourSubpageClosing,
...
export default async function TourTravelTipsPage({
  params,
}: {
    ...
    <TourDemoShell config={config}>
      <main className="pb-28 lg:pb-10">
        <TourSubpageHero
          ...
          slug={slug}
        />
        <TourTravelTipsBrowse config={config} locale={locale} slug={slug} />
